...
Common mappings you must apply:
  "Bank Charges & Fees", "Bank Service Charges"  → "Bank Charges"
  ...
  "Subcontractors", "Contractors", "Subs", "Subcontractors – Painting" → "Subcontractors"
  "Labor", "Field Labor", "Crew Labor", "Direct Field Labor – Painting" → "Direct Field Labor"
  "Paint", "Paint & Primer", "Materials", "Paint & Materials", "Job Supplies" → "Job Supplies & Materials"
  ...
  "Income", "Revenue", "Sales", "Painting Revenue" → "Service Revenue"
